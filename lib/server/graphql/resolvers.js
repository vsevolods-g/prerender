...
const setSettingsForDomain = require('./resolver/setSettingsForDomain');
...
const fetchSettingsForDomain = require('./resolver/fetchSettingsForDomain');
...
const resolvers = {
    Query: {
        ...
        fetchSettingsForDomain: authenticated(fetchSettingsForDomain),
    ...
    Mutation: {
        ...
        setSettingsForDomain: authenticated(setSettingsForDomain),
